             ...
             {files.map((f) => (
                ...
                >
                  <div className="flex items-center gap-4 relative z-10">
                     <div className={`shrink-0 w-10 h-10 rounded-xl flex items-center justify-center border ${f.status === 'error' ? 'bg-rose-500/10 border-rose-500/20 text-rose-400' : 'bg-zinc-900 border-zinc-800 text-zinc-400'}`}>
